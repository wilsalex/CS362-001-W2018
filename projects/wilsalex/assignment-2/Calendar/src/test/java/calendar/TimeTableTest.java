...
public class TimeTableTest {
    ...
    public void testGetApptRange(){
        ...
        try{
            table.getApptRange(apptList, new GregorianCalendar(2017,2,21), new GregorianCalendar(2017,2,20));
        }
        ...
        //testing valid dates
        /*try {
            LinkedList<CalDay> result = table.getApptRange(apptList, new GregorianCalendar(2017, 2, 18), new GregorianCalendar(2017, 2, 21));
            assertEquals(20, result.get(0).getDay());
        }
        catch(DateOutOfRangeException e){
        }*/
